...
#pragma region Textures
	Texture texture;
	GLuint textureID[7];
		textureID[0] = texture.LoadTextures("Textures/Robot.bmp");
		textureID[1] = texture.LoadTextures("Textures/box.bmp");
		textureID[2] = texture.LoadTextures("Textures/Texture.bmp");
		textureID[3] = texture.LoadTextures("Textures/Texture4.bmp");
		textureID[4] = texture.LoadTextures("Textures/background.jpg");
		textureID[5] = texture.LoadTextures("Textures/Texture2.bmp");
		textureID[6] = texture.LoadTextures("Textures/Texture3.bmp");
	...
	//assinging textureID
	objs[0].textureID = textureID[2];
	objs[1].textureID = textureID[0];
	objs[2].textureID = textureID[1];
#pragma endregion

#pragma region Transformations
	//assigning location
	objs[0].trans.location = { 0, 0, -.3 };
	objs[1].trans.location = { -.4,-.3,0 };
